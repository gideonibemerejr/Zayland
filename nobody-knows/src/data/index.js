...
export function getAlbumCredits() {
  return {
    story: `<i>Nobody Knows</i> is about how lost we all feel in times of uncertainty. <br /><br />This project is an expression of different emotions I've been feeling over the past few months.Whether it be navigating relationships, fighting through emotions, or figuring out how to express myself.`,
    credits: {
    ...
    end: `At the end of the day we’re all just winging this shit, this is a story of me winging it. These songs are how I coped with different emotions. Hopefully you can relate.`
  };
}
