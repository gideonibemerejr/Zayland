              ...
              >
				...
				<div className="w-100 flex flex-column justify-center items-center">
					<div className=" db-l flex flex-column justify-center items-center">
						...
						<p className="tc red">{this.state.product.description}</p>
						<h3 className="f2-ns f3 tc ttu tracked mt3 fw6 black-70 white">
							${this.state.variant && this.state.variant.price | 0}
						</h3>

						<div className="mt2 flex flex-column-m flex-row items-center justify-center justify-around w-100 white">
							...
							<div className="flex flex-column flex-row-l items-center justify-center justify-between-ns  mt4-m mt0 mr0 w-25-ns w-50">
								...
								<input
									className="bg-transparent white fw5 w-50 quantity-input"
									min="1"
									type="number"
						...
						<div className="mt4-ns mt4 mx-auto flex justify-center">
							<button
								className="f3-ns f5 pa2 bg-transparent b--white bw1 button w-50-l w-100 white fw5"
								onClick={() =>
